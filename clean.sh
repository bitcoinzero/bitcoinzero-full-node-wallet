...
read -p "Are you sure you want to delete your entire BCZ blockchain? (y/N) " -n 1 -r
echo    # (optional) move to a new line
if [[ $REPLY =~ ^[Yy]$ ]]
then
	echo "deleting ~/Library/Application Support/bitcoinzero/blocks"
    rm -rf ~/Library/Application Support/bitcoinzero/blocks
    echo "deleting ~/Library/Application Support/bitcoinzero/chainstate"
    rm -rf ~/Library/Application Support/bitcoinzero/chainstate
    echo "success."
else
	echo "Aborted."
fi